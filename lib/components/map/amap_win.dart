...
class AmapWin extends StatefulWidget {
  final bool select;
  final EXIFData data;
  ...
  @override
  State<AmapWin> createState() => _AmapWinState();
}

class _AmapWinState extends State<AmapWin> {
  ...
  @override
  void didUpdateWidget(covariant AmapWin oldWidget){
